...
import { LogOut, Menu, X, Bell, LayoutDashboard, Users, Award, FileText, Settings, ShieldAlert, GraduationCap, Clock, MessageSquare, Link as LinkIcon, AlertTriangle, User as UserIcon, ChevronDown, Calendar } from 'lucide-react';
...
const roleLinks: Record<Role, SidebarLink[]> = {
  ...
  Student: [
    ...
    { name: 'Sertifikatlar', path: '/student/certificates', icon: FileText },
...
export default function DashboardLayout() {
  const { currentUser, logout, absenceRequests } = useAppContext();
  const navigate = useNavigate();
