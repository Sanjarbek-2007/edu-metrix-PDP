              ...
              <div key={s.id} className={cn(
                ...
                <div className="flex justify-between items-center mt-auto pt-2">
                  <div className="flex flex-col">
                    <span className="text-[10px] font-extrabold text-[#9DB4AB] uppercase tracking-widest leading-none mb-1">Xulq balli</span>
                    <span className="text-xl font-black text-[#0D1F1A]">{s.scores.xulq}/20</span>
                  </div>
